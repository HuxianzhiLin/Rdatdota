...
get_player_avg <- function(patch = "7.19",
  ...
  #result
  dota_result <- get_response(dota_api_category = "players", dota_api_subcategory = "performances", args = args)
