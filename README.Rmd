...
The typical workflow of Rdatdota would include using the get_* family functions to access the API. You don't need any keys for the dat dota API. Here is an example:
```{r eval = FALSE}
...
To read the tutorial and documentation for rdatdota please visit [Rdatdota](https://github.com/QMSS-G5072-2018/Huxianzhi_Lin/blob/master/final%20project/Rdatdota/vignettes/rdatdota.Rmd).

To check the data on the website you can visit
[datdota](www.datdota.com)
